<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index_admin.aspx.cs" Inherits="DAS_Project.admin.html.index_admin" %>
        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand ms-4" href="index_admin.aspx">
                        <!-- Logo icon -->
                        <b class="logo-icon">
